...
image: '/images/posts/domas-art.png'
comments: true
---
...
Due to this charming origin of WASM games, I have also made [Crimson](/projects/crimson) support it, so you can leverage easy game development process that does not require a lot of space, neither many resources to test (unlike some commercial engines).
